  ...
  <div class="header">
    ...
    <div class="left_content">
      ...
      try{
    	...
    	System.out.println("UUUPdate add buyerId "+ buyerId); 
    	System.out.println("UUUPdate add addressId "+ addressId); 
		if (buyerId != null && addressId!=null) {
			Address address = em.find(Address.class, Integer.parseInt(addressId));
			if (address != null) {
		%>
			   <div class="contact_form">
          <div class="form_subtitle">update address</div>
          <form name="register" method="post" action="AdminServlet">
        		<div class="form_row">
        		<label class="contact"><strong>Street Number:</strong></label>
        		<input type="text" name="streetNumber" value=<%=address.getStreetNumber() %>>
            	</div>
           		<div class="form_row">
        		...
        		<input type="text" name="state" value=<%=address.getSate() %>>
            	</div>
            	<div class="form_row">
