      ...
      try{
		...
		%>
          ...
          <form name="register" method="post" action="AdminServlet">
        		...
        		<input type="text" name="firstName" value=<%=seller.getFirstName() %>>
            	</div>
           		<div class="form_row">
        		<label class="contact"><strong>last name:</strong></label>
        		<input type="text" name="lastName" value=<%=seller.getLastName() %>>
            	</div>
            	<div class="form_row">
        		<label class="contact"><strong>log name:</strong></label>
        		<input type="text" name="logName" value=<%=seller.getLastName() %>>
            	</div>
            	<div class="form_row">
        		<label class="contact"><strong>passcode:</strong></label>
        		<input type="text" name="passcode" value=<%=seller.getPasscode()%>>
            	</div>
           		<div class="form_row">
            	<input type="submit" class="register" value="update">
            	<input type="hidden" name="command" value="updateSellerInfo">
