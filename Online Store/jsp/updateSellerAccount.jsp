  ...
  <div class="header">
    ...
    <div class="left_content">
      ...
      try{
      	...
      	System.out.println("updateSellerAccount entered sellerId" + sellerId);
      	System.out.println("updateSellerAccount entered sellerAccountId" + sellerAccountId);
		if (sellerId != null && sellerAccountId!=null) {
			BankAccount bankAccount = em.find(BankAccount.class, Integer.parseInt(sellerAccountId));
			if (bankAccount != null) {
		%>
		
		        <div class="contact_form">
          <div class="form_subtitle">update bank account</div>
          
          <form name="register" method="post" action="AdminServlet">
        		<div class="form_row">
        		<label class="contact"><strong>Number:</strong></label>
        		<input type="text" name="sellerAccountNumber" value=<%=bankAccount.getNumber() %>>
            	</div>
           		<div class="form_row">
        		<label class="contact"><strong>Amount:</strong></label>
        		<input type="text" name="sellerAccountAmount" value=<%=bankAccount.getAmount() %>>
            	</div>
            	<div class="form_row">
        		<label class="contact"><strong>Routing:</strong></label>
        		<input type="text" name="sellerAccountRouting" value=<%=bankAccount.getRouting() %>>
            	</div>
           		<div class="form_row">
            	<input type="submit" class="register" value="update" >
            	<input type="hidden" name="command" value="updateSellerAccount" >
